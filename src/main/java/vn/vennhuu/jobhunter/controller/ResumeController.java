...
import vn.vennhuu.jobhunter.domain.Resume;
import vn.vennhuu.jobhunter.domain.User;
import vn.vennhuu.jobhunter.domain.response.ResultPaginationDTO;
import vn.vennhuu.jobhunter.domain.response.resume.ResCreateResumeDTO;
import vn.vennhuu.jobhunter.domain.response.resume.ResResumeDTO;
import vn.vennhuu.jobhunter.domain.response.resume.ResUpdateResumeDTO;
import vn.vennhuu.jobhunter.service.ResumeService;
import vn.vennhuu.jobhunter.service.UserService;
...
import vn.vennhuu.jobhunter.service.JobService;
