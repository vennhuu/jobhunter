package vn.vennhuu.jobhunter.config;
...
import vn.vennhuu.jobhunter.repository.PermissionRepository;
import vn.vennhuu.jobhunter.repository.RoleRepository;
import vn.vennhuu.jobhunter.repository.UserRepository;
import vn.vennhuu.jobhunter.util.constant.GenderEnum;
...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if ( countPermissions == 0 ) {
            ...
            arr.add(new Permission("Get a company by id" , "/api/v1/companies" , "GET" , "COMPANIES")) ;
            ...
            arr.add(new Permission("Get a job by id" , "/api/jobs" , "GET" , "JOBS")) ;
            arr.add(new Permission("Get jobs with pagination" , "/api/v1/jobs" , "GET" , "JOBS")) ;

            arr.add(new Permission("Create a permission" , "/api/v1/permissions" , "POST" , "PERMISSIONS")) ;
            arr.add(new Permission("Update a permission" , "/api/v1/permissions" , "PUT" , "PERMISSIONS")) ;
            arr.add(new Permission("Delete a permission" , "/api/v1/permissions/{id}" , "DELETE" , "PERMISSIONS")) ;
            arr.add(new Permission("Get a permission by id" , "/api/v1/permissions" , "GET" , "PERMISSIONS")) ;
            ...
            arr.add(new Permission("Get a resume by id" , "/api/v1/resumes" , "GET" , "RESUMES")) ;
            arr.add(new Permission("Get resumes with pagination" , "/api/v1/resumes" , "GET" , "RESUMES")) ;

            arr.add(new Permission("Create a role" , "/api/v1/roles" , "POST" , "ROLES")) ;
            arr.add(new Permission("Update a role" , "/api/v1/roles" , "PUT" , "ROLES")) ;
            arr.add(new Permission("Delete a role" , "/api/v1/roles/{id}" , "DELETE" , "ROLES")) ;
            arr.add(new Permission("Get a role by id" , "/api/v1/roles" , "GET" , "ROLES")) ;
            arr.add(new Permission("Get roles with pagination" , "/api/v1/roles" , "GET" , "ROLES")) ;

            arr.add(new Permission("Create a user" , "/api/v1/users" , "POST" , "USERS")) ;
            arr.add(new Permission("Update a user" , "/api/v1/users" , "PUT" , "USERS")) ;
            arr.add(new Permission("Delete a user" , "/api/v1/users/{id}" , "DELETE" , "USERS")) ;
            arr.add(new Permission("Get a user by id" , "/api/v1/users" , "GET" , "USERS")) ;
            ...
            arr.add(new Permission("Get a subscriber by id" , "/api/v1/subscribers" , "GET" , "SUBSCRIBERS")) ;
            arr.add(new Permission("Get subscribers with pagination" , "/api/v1/subscribers" , "GET" , "SUBSCRIBERS")) ;

            arr.add(new Permission("Download a file" , "/api/v1/files" , "POST" , "SUBSCRIBERS")) ;
            arr.add(new Permission("Upload a file" , "/api/v1/files" , "GET" , "SUBSCRIBERS")) ;
        ...
        if ( countUsers == 0 ) {
            ...
            adminUser.setName("I am super admin haha") ;
